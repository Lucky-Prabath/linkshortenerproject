...
This file is the entry point for all LLM agent and coding-assistant instructions for this project. Detailed standards are split into topic-specific files in the `/docs` directory. **Read all linked docs before making any changes.**
